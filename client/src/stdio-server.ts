      ...
      tools: [
        {
          name: "deploy_html",
          description:
            "Deploy a single HTML file as a website. Returns a public URL for the deployed page.",
          inputSchema: {
            type: "object",
            properties: {
              value: {
        ...
        },
        {
          name: "deploy_folder",
          description:
            "Deploy a local folder as a static website. Recursively uploads all files. The folder must contain index.html at the root. Returns a public URL.",
          inputSchema: {
            type: "object",
            properties: {
              path: {
